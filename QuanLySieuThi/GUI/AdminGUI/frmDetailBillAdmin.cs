...
{
    public partial class frmDetailBillAdmin : Form
    {
        ...
        string pMaHD;
        public frmDetailBillAdmin(string _mahd)
        {
            InitializeComponent();
            pMaHD = _mahd;
            this.Load += FrmDetailBillAdmin_Load;
        }

        private void FrmDetailBillAdmin_Load(object sender, EventArgs e)
        {
            loadData();
            loadProductAllItems();
        }
